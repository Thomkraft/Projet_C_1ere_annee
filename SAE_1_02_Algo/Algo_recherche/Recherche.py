...
#Tri par recherche pour trouver le nom ou la comagnie
#tab 10 : 
#tab 500 : 
#tab 5000 : 
...
while i < 10:
    ind, compteur = recherche_dicho(tab_5000[i],50)
    calcul = calcul + compteur
    i = i+1
print(f"La moyenne d'operation elementaire est de : {calcul/10}")

'''
while i < 10:
    calcul = calcul + tri_selection(tab_10[i],2)
    i = i+1
print(f"La moyenne d'operation elementaire est de : {calcul/10}")
'''